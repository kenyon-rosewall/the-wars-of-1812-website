...
if (version.indexOf("Mac") != -1) {
  document.write('<link rel=stylesheet href=\"../../_sharedassets/help_mac.css\" TYPE=\"text/css\">');
}
else if (version.indexOf("Windows") != -1) {
  document.write('<link rel=stylesheet href=\"../../_sharedassets/help_pc.css\" TYPE=\"text/css\">');
}
else {
