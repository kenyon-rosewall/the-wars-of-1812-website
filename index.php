...
Header( "Location: http://www.myspace.com/thewarsof1812" ); 
?> 
...
//-->
	...
	<script type="text/javascript">
		...
		function cancelKeys(key) {
			
		}
		jQuery(document).ready(function() {
			jQuery('#content').load('dyn/home.php');
		...
		function loadMain(el) {
			...
			var url = 'dyn/' + el.src.replace(/.+\//,'').replace('_roll.jpg','.php');
			//alert(url);
  ...
  <table cellpadding="0" cellspacing="0" border="0" align="center">
    ...
    <div id="wrapper">
      <div id="header">
        <a style="border: 0px solid black;" href="http://thewarsof1812.com"><img src="imgs/wars_label_logo.jpg" style="border: 0px solid black;" width="900" height="67" /></a>      </div>
      <div id="content">
      ...
      <div id="footer">
        <div id="navigation">
          <ul>
            ...
            <li><img src="images/rolls/forums.jpg" border="0" onmouseover="rollOver(this)" onclick="loadMain(this)" onmouseout="rollOut(this)" /></li>
